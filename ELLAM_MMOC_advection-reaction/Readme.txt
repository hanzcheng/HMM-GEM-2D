...
2. PolygonClip - clips out the polygonal region of intersection bet. 2 polygons (source: http://www.cs.man.ac.uk/~toby/gpc/)
3. write_solution_vtk - writes a vtk file for visualising the solution profile
4. write_solution_ensight - writes an ensight file for visualising the solution profile (note: Here, the results are written in a different folder, in this case, specified to be ensight/Un. Users may opt to change where the results are written by changing lines 121-134.) 
